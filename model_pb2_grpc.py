...
import model_pb2 as protos_dot_model__pb2
...
class PredictionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Health = channel.unary_unary(
                ...
                request_serializer=protos_dot_model__pb2.Empty.SerializeToString,
...
def add_PredictionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Health': grpc.unary_unary_rpc_method_handler(
                    servicer.Health,
                    request_deserializer=protos_dot_model__pb2.Empty.FromString,
...
class PredictionService(object):
    ...
    def Health(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/PredictionService/Health',
            protos_dot_model__pb2.Empty.SerializeToString,
